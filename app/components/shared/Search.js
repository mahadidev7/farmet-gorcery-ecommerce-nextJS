...
const Search = () => {
  return (
    <div className=' bg-gray-100 p-4 rounded-lg hidden md:flex item-center gap-2 justify-between lg:min-w-[650px] mx-4'>
        <select name="product_cat" className="outline-none bg-transparent cursor-pointer">
        ...
        <input 
            ...
            className='bg-transparent px-4 outline-none border-1 border-gray-400 flex-1'
        />
